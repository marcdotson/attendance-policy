#This code contains trimester 1 absense data diff-in-diff as well as creation of line charts to show trends
...
#make the line chart taking into account differing trimester length
plt.figure(figsize=(10,6))
...
# Calculate the differences between SV and GC for each T1 
