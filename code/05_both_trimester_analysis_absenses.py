#----------------------------------------
# Attendance Comparison: GC vs SV (T1 & T2)
#----------------------------------------
...
print("GC 2023 T1 Averages:\n", gc_2023_avg_t1)
print("SV 2023 T1 Averages:\n", sv_2023_avg_t1)
print("GC 2024 T1 Averages:\n", gc_2024_avg_t1)
print("SV 2024 T1 Averages:\n", sv_2024_avg_t1)
...
axes[0].set_title('T1: SV - GC Differences', fontsize=16, pad=15)
axes[0].set_xlabel('Period', fontsize=14)
axes[0].set_ylabel('Average Absence Difference', fontsize=14)
...
axes[1].set_title('T2: SV - GC Differences', fontsize=16, pad=15)
...
#----------------------------------------
# 6. Plot Average Absences by School (T1 and T2)
#----------------------------------------
...
axes[0].set_title('T1: Average Absences', fontsize=16, pad=15)
axes[0].set_xlabel('Period', fontsize=14)
axes[0].set_ylabel('Average Absences', fontsize=14)
axes[0].legend(loc='best')
axes[0].grid(True)
...
axes[1].set_title('T2: Average Absences', fontsize=16, pad=15)
axes[1].set_xlabel('Period', fontsize=14)
axes[1].legend(loc='best')
axes[1].grid(True)
