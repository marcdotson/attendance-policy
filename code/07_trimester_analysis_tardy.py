...
print(f'T1 Mean GC tardies before: {mean_gc_2023_t1:.2f}')
print(f'T1 Mean SV tardies before: {mean_sv_2023_t1:.2f}')
print(f'T1 Mean GC tardies after: {mean_gc_2024_t1:.2f}')
print(f'T1 Mean SV tardies after: {mean_sv_2024_t1:.2f}')
print(f'T1 DID in mean tardies: {did_t1:.2f}')
...
print(f'T2 Mean GC tardies before: {mean_gc_2023_t2:.2f}')
print(f'T2 Mean SV tardies before: {mean_sv_2023_t2:.2f}')
print(f'T2 Mean GC tardies after: {mean_gc_2024_t2:.2f}')
print(f'T2 Mean SV tardies after: {mean_sv_2024_t2:.2f}')
print(f'T2 DID in mean tardies: {did_t2:.2f}')