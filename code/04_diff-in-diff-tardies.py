#----------------------------------------
# Diff-in-Diff of Tardies: GC vs SV (T1, T2, & T3)
#----------------------------------------
...
# Trimester 1
ols_model = ols('avg_tardies ~ school + year + school_year', data=df_reg_t1).fit()
print(ols_model.summary())

mean_gc_2023_t1 = gc_2023_long_t1['avg_tardies'].mean()
mean_sv_2023_t1 = sv_2023_long_t1['avg_tardies'].mean()
mean_gc_2024_t1 = gc_2024_long_t1['avg_tardies'].mean()
mean_sv_2024_t1 = sv_2024_long_t1['avg_tardies'].mean()
...
print(f'Mean GC Tardies Before: {mean_gc_2023_t1:.2f}')
print(f'Mean SV Tardies Before: {mean_sv_2023_t1:.2f}')
print(f'Mean GC Tardies After: {mean_gc_2024_t1:.2f}')
print(f'Mean SV Tardies After: {mean_sv_2024_t1:.2f}')
print(f'DID in Mean Tardies: {did_t1:.2f}')

# Trimester 2
ols_model = ols('avg_tardies ~ school + year + school_year', data=df_reg_t2).fit()
print(ols_model.summary())

mean_gc_2023_t2 = gc_2023_long_t2['avg_tardies'].mean()
mean_sv_2023_t2 = sv_2023_long_t2['avg_tardies'].mean()
mean_gc_2024_t2 = gc_2024_long_t2['avg_tardies'].mean()
mean_sv_2024_t2 = sv_2024_long_t2['avg_tardies'].mean()
...
print(f'\nManual DID Calculation:')
print(f'Mean GC Tardies Before: {mean_gc_2023_t2:.2f}')
print(f'Mean SV Tardies Before: {mean_sv_2023_t2:.2f}')
print(f'Mean GC Tardies After: {mean_gc_2024_t2:.2f}')
print(f'Mean SV Tardies After: {mean_sv_2024_t2:.2f}')
print(f'DID in Mean Tardies: {did_t2:.2f}')

# Trimester 3
ols_model = ols('avg_tardies ~ school + year + school_year', data=df_reg_t3).fit()
print(ols_model.summary())

mean_gc_2023_t3 = gc_2023_long_t3['avg_tardies'].mean()
mean_sv_2023_t3 = sv_2023_long_t3['avg_tardies'].mean()
mean_gc_2024_t3 = gc_2024_long_t3['avg_tardies'].mean()
mean_sv_2024_t3 = sv_2024_long_t3['avg_tardies'].mean()
...
print(f'\nManual DID Calculation:')
print(f'Mean GC Tardies Before: {mean_gc_2023_t3:.2f}')
print(f'Mean SV Tardies Before: {mean_sv_2023_t3:.2f}')
print(f'Mean GC Tardies After: {mean_gc_2024_t3:.2f}')
print(f'Mean SV Tardies After: {mean_sv_2024_t3:.2f}')
print(f'DID in Mean Tardies: {did_t3:.2f}')
